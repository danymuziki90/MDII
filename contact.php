    ...
    <div class="row" data-aos="fade-up">
      <div class="col-12" data-aos="fade-up">
        ...
        <div class="breadcrumb-content text-center" data-aos="fade-up">
          <h2 class="text-white text-uppercase mb-3">Contact</h2>
          <ol class="breadcrumb d-flex justify-content-center">
            <li class="breadcrumb-item"><a class="text-uppercase text-white" href="index.html">Accuiel</a></li>
            <li class="breadcrumb-item"><a class="text-uppercase text-white" href="#">Blog</a></li>
    ...
    <div class="row justify-content-between align-items-center" data-aos="fade-up">
      <div class="col-12 col-lg-5">
        ...
        <div class="section-heading text-center " data-aos="fade-up">
          ...
          <p class="d-none d-sm-block mt-4" data-aos="fade-up">Si vous avez une question, un commentaire ou une idée,
            veuillez remplir le formulaire ou nous appeler, et nous vous répondrons dans les plus brefs délais.</p>
        </div>
        <!-- Contact Us -->
        <div class="contact-us" data-aos="fade-up">
          <ul>
            ...
            <li class="contact-info color-1 bg-hover active hover-bottom text-center p-5 m-3">
              ...
              <a class="d-block my-2" href="tel:+243976829426">
                <h3>+243 976 829 426</h3>
              </a>
            ...
            <li class="contact-info color-3 bg-hover active hover-bottom text-center p-5 m-3" data-aos="fade-up">
              ...
              <a class="d-none d-sm-block my-2" href="mailto:mjvdccommunaute18@gmail.com">
                <h3>mjvdccommunaute18@gmail.com</h3>
              </a>
              <a class="d-block d-sm-none my-2" href="mailto:mjvdccommunaute18@gmail.com">
                <h3>mjvdccommunaute18@gmail.com</h3>
              </a>
      ...
      <div class="col-12 col-lg-6 pt-4 pt-lg-0">
        ...
        <div class="contact-box text-center" data-aos="fade-up">
          ...
          <?php
                            ...
                            $subject = "New Enquiry from MDI Website";
                            $mailheader = "From: noreply@MDI.com \r\n";
            ...
            <div class="row">
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-bordered active btn-block mt-3" name="save"><span
                    class="text-white pr-3"><i class="fas fa-paper-plane"></i></span>Envoyer</button>
              </div>
            </div>
          </form>
